...
BasicStrategyAI::Action BasicStrategyAI::getAction(int playerScore, int dealerUpCard, bool isSoftHand, bool canSplit) const {
...
BasicStrategyAI::Action BasicStrategyAI::getHardHandAction(int playerScore, int dealerUpCard) const {
    // 5-8: Always hit
    if (playerScore <= 8) {
        return Action::HIT;
    }
...
BasicStrategyAI::Action BasicStrategyAI::getSoftHandAction(int playerScore, int dealerUpCard) const {
...
BasicStrategyAI::Action BasicStrategyAI::getPairAction(int pairValue, int dealerUpCard) const {
